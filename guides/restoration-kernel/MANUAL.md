...
**EXEC** (cast) is always the one-thumb action. It pulls ambient essence and advances Arcane Bits (AB).

## Pipeline roles

Build along a clear structure — not four identical elemental ladders:

| Role | Job |
|------|-----|
| **Capture** | Pull essence from ambient hex noise |
| **Store** | Raise unbound capacity so soft fade stops eating your stock |
| **Bind** | Fuse streams into Distilled Aether |
| **Compile** | Turn preserved stock into lasting AB |
| **Shield** | Scarce global fade dampeners |
...
A single compile contract is the primary objective. No dual quest HUD. Contracts are sector stakes (“bring Fire Sector Tap online”), not generic daily spam.
