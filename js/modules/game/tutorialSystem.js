...
export class TutorialSystem {
        ...
        this.tutorialSteps = [
            ...
            },
            {
                ...
                action: () => {
                    ...
                    if (this.uiManager?.switchTab) {
                        this.uiManager.switchTab('workstations');
                    }
                }
            },
            {
            ...
            },
            {
                ...
                action: () => {
                    if (this.uiManager?.switchTab) {
                        this.uiManager.switchTab('inscriptions');
                    }
                }
            },
            {
    ...
    completeTutorial() {
        ...
        if (this.uiManager?.showNotification) {
            this.uiManager.showNotification('Tutorial completed!', 'success');
        }
    }
